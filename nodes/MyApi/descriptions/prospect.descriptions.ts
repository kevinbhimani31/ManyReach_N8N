...
export const prospectFields: INodeProperties[] = [
...

  {
    ...
    options: [
    { displayName: 'Sending Status', name: 'sendingStatus', type: 'options', default: 'Unknown', options: [{ name: 'Unknown', value: 'Unknown' }, { name: 'EspMatchNotFound', value: 'EspMatchNotFound' }, { name: 'EspNotAllowed', value: 'EspNotAllowed' }, { name: 'NoWarmup', value: 'NoWarmup' }, { name: 'NotReceiving', value: 'NotReceiving' }, { name: 'WarmupLimits', value: 'WarmupLimits' }, { name: 'SendingLimits', value: 'SendingLimits' }, { name: 'NoSender', value: 'NoSender' }, { name: 'Stuck', value: 'Stuck' }, { name: 'MailboxInexistent', value: 'MailboxInexistent' }, { name: 'EmptySubject', value: 'EmptySubject' }, { name: 'EmptyBody', value: 'EmptyBody' }, { name: 'MissingPh', value: 'MissingPh' }, { name: 'Invalid', value: 'Invalid' }, { name: 'Blacklisted', value: 'Blacklisted' }, { name: 'Stopped', value: 'Stopped' }, { name: 'Unsub', value: 'Unsub' }, { name: 'BounceHard', value: 'BounceHard' }, { name: 'BounceSoft', value: 'BounceSoft' }, { name: 'AutoNolonger', value: 'AutoNolonger' }, { name: 'AutoOoo', value: 'AutoOoo' }, { name: 'AutoReply', value: 'AutoReply' }, { name: 'CollegueReplied', value: 'CollegueReplied' }, { name: 'SenderDisconnected', value: 'SenderDisconnected' }, { name: 'Paused', value: 'Paused' }, { name: 'InsufficientCredit', value: 'InsufficientCredit' }, { name: 'ScheduleInactive', value: 'ScheduleInactive' }, { name: 'NotInterested', value: 'NotInterested' }, { name: 'NotSet', value: 'NotSet' }, { name: 'Neutral', value: 'Neutral' }, { name: 'MaybeLater', value: 'MaybeLater' }, { name: 'Interested', value: 'Interested' }, { name: 'MeetingBooked', value: 'MeetingBooked' }, { name: 'MeetingCompleted', value: 'MeetingCompleted' }, { name: 'Won', value: 'Won' }, { name: 'Subbed', value: 'Subbed' }] },
